...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graph_widget.setGeometry(QtCore.QRect(9, 10, 750, 580))
        #self.graph_widget.setStyleSheet("background-color: rgb(0, 0, 0);")
        ...
        if check_e_r == False:
            ...
            if check_e_b == False:
                ...
                if check_d_b == False:
                    ...
                    self.graph_widget = fig.add_subplot(111)
